        ...
        for g in gn:
            for t in ts:
                ...
                for app in apps:
                    ...
                    if app != 'random':
                        test = readTCPfile(subject_path + str(t) + 'avg-new/group' + str(g) + '/' + app)
                        ...
                        #m2 = time.time()- mtime2
                        writefile(subject_path + str(t) + 'avg-new/evaluate/' + str(g) + '/',app,temptime1,temptime2,temptime3)
                        ...
                        for i in tqdm(range(50)):
                            test = readTCPfile(subject_path + str(t) + 'avg-new/group' + str(g) + '/random/random' + str(i) + '.txt')
                            test_index = TestName_Index(test,testlist)
                            temptime1,temptime2,temptime3 = DetectedTime(test_index,timelist,mutantmap,index_list)
                            rtime.append(temptime1)
                            ftime.append(temptime2)
                            ltime.append(temptime3)
                            writefileSingle(subject_path + str(t) + 'avg-new/evaluate/' + str(g) + '/',str(app) + str(i),temptime1,temptime2,temptime3)
                        print sindex + ' : ' + app + str(i) + ' is completed! ' 
                        writefile(subject_path + str(t) + 'avg-new/evaluate/' + str(g) + '/',app,sum(rtime)/(len(rtime)*1.0),sum(ftime)/(len(ftime)*1.0),sum(ltime)/(len(ltime)*1.0))
