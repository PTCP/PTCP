...
def getCandidateTest(temp_list,temp_str):
        ...
        for i in range(len(temp_list)):
                ...
                temp_number = getAllCount(temp_number_list)
...
if __name__ == '__main__':
        ...
        for subject_item in subject_list:
                ...
                print count
                '''
                f = open(subject_path + str(tl_n) + 'avg-new/group'+str(g_n)+'/greedyadditional_withouttime.txt','w')
                for group_item in tt:
                        for test_item in group_item:
                                f.write(test_item + '\t')
                        f.write('\n')
                f.close()
                f_time = open(subject_path + str(tl_n) + 'avg-new/group'+str(g_n)+'/timegreedyadditional_withouttime','w')
                f_time.write(str(prioritize_time))
                f_time.close()
                f_tolerate = open(subject_path + str(tl_n) + 'avg-new/group'+str(g_n)+'/tolerategreedyadditional_withouttime','w')
