...
if __name__ == "__main__":
    ...
    for metric in metrics:
        f = open('data_testclass/%s_all.csv'%metric,'w')
        for app in app_list:
            f.write('%s,'%app)
    ...
    for metric in metrics:
        for gitem in gn:
            f = open('data_testclass/%s_all_%s.csv'%(metric,gitem),'w')
            for app in app_list:
                f.write('%s,'%app)
            f.write('subject,gn,ts\n')
            for subject in subjects:
    ...
    for metric in metrics:
        for titem in ts:
            f = open('data_testclass/%s_all_%s.csv'%(metric,titem),'w')
            for app in app_list:
                f.write('%s,'%app)
            f.write('subject,gn,ts\n')
            for subject in subjects:
